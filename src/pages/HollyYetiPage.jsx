...
function HostCard({ name, role, children, to, href }) {
  const inner = (
    <>
      <div style={{ fontFamily: SERIF, fontSize: '1.25rem', fontWeight: 700, color: '#1c2b29', marginBottom: '0.2rem' }}>{name}</div>
      <div style={{ fontSize: '0.75rem', fontWeight: 700, color: '#e64774', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '0.75rem' }}>{role}</div>
      <div style={{ fontSize: '0.95rem', color: '#4a5654', lineHeight: 1.7 }}>{children}</div>
    </>
  );
  const box = { display: 'block', textDecoration: 'none', color: 'inherit', background: 'white', border: '1px solid #eeddd8', borderRadius: '14px', padding: '1.5rem' };
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#fdf7f5', fontFamily: FONT, color: '#1c2b29' }}>
        ...
        <div style={{ position: 'relative', zIndex: 2, maxWidth: '1100px', margin: '0 auto', width: '100%', padding: '9rem 1.5rem 3rem' }}>
          <div style={{ maxWidth: '640px' }}>
            ...
            <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap', marginBottom: '1.5rem' }}>
              <Link to="/listings" style={{ padding: '0.8rem 1.6rem', background: '#e64774', color: 'white', borderRadius: '10px', textDecoration: 'none', fontWeight: 700, fontSize: '0.95rem' }}>See Holly&rsquo;s listings</Link>
      ...
      <div style={{ maxWidth: '960px', margin: '0 auto', padding: '3rem 1.5rem 1rem' }}>
        ...
        <section style={{ marginBottom: '3rem' }}>
          <div style={{ fontSize: '0.78rem', fontWeight: 700, color: '#98a3a1', textTransform: 'uppercase', letterSpacing: '0.6px', marginBottom: '0.5rem' }}>Off camera</div>
          ...
          <div className="hy-next">
            <Link to="/sold" style={{ ...card, display: 'block', textDecoration: 'none', color: 'inherit' }}>
              ...
              <div style={{ fontSize: '0.88rem', color: '#66706e', lineHeight: 1.6 }}>The whole {year} list, with what each one sold for.</div>
            </Link>
            <Link to="/listings" style={{ ...card, display: 'block', textDecoration: 'none', color: 'inherit' }}>
              ...
              <div style={{ fontSize: '0.88rem', color: '#66706e', lineHeight: 1.6 }}>What is on the market around the lakes today.</div>
            </Link>
            <Link to="/cma" style={{ ...card, display: 'block', textDecoration: 'none', color: 'inherit' }}>
              ...
              <div style={{ fontSize: '0.88rem', color: '#66706e', lineHeight: 1.6 }}>Answered with sales on your lake, not a national guess.</div>
            </Link>
          </div>
        </section>
